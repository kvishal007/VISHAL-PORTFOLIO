      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        <div className="md:w-1/2">
          <h2 className="text-3xl font-bold text-white mb-6 flex items-center">
            <span className="text-accent mr-2 text-xl font-normal">01.</span> About Me
          </h2>
        ...
        <div className="md:w-1/2 flex justify-center mt-10 md:mt-0">
          <div className="relative group w-64 h-64 md:w-80 md:h-80 mx-auto">
            ...
            <div className="relative w-full h-full bg-secondary rounded-xl overflow-hidden z-10 transition-transform group-hover:-translate-x-1 group-hover:-translate-y-1">
              <div className="absolute inset-0 bg-accent/20 group-hover:bg-transparent transition-colors z-20"></div>
              <img src="/vishal.png" alt="K.VISHAL" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
            </div>
          </div>
        </div>
      </div>
